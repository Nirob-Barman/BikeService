    ...
    : IRequestHandler<GetDashboardQuery, Result<DashboardDto>>
{
    public async Task<Result<DashboardDto>> Handle(GetDashboardQuery request, CancellationToken cancellationToken)
    {
        ...
        var paidInvoices = await unitOfWork.Repository<Invoice>()
        ...
        // Ticket stats
        var allTickets = await unitOfWork.Repository<ServiceTicket>().GetAllAsync();
        ...
        var allBikes = await unitOfWork.Repository<CustomerBike>().GetAllAsync();
        ...
        // Top services
        var allItems = await unitOfWork.Repository<ServiceTicketItem>()
        ...
        // Top mechanics
        var deliveredTickets = await unitOfWork.Repository<ServiceTicket>()

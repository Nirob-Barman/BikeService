    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerBikes_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartStockAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartStockAlerts_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_CustomerBikes_BikeId",
                        column: x => x.BikeId,
                        principalTable: "CustomerBikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Mechanics_MechanicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollRecords_Mechanics_MechanicId",
                        column: x => x.MechanicId,
                        principalTable: "Mechanics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DiagnosisNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceTickets_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ServiceTickets_CustomerBikes_BikeId",
                        column: x => x.BikeId,
                        principalTable: "CustomerBikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceTickets_Mechanics_MechanicId",
                        column: x => x.MechanicId,
                        principalTable: "Mechanics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Invoices_ServiceTickets_ServiceTicketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_ServiceTickets_ServiceTicketId",
                        column: x => x.ServiceTicketId,
                        principalTable: "ServiceTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceTicketItems_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceTicketItems_ServiceTickets_ServiceTicketId",
                        column: x => x.ServiceTicketId,
                        principalTable: "ServiceTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceTicketItems_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketNotes_ServiceTickets_ServiceTicketId",
                        column: x => x.ServiceTicketId,
                        principalTable: "ServiceTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBikes_CustomerId",
                table: "CustomerBikes",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ServiceTicketId",
                table: "Invoices",
                column: "ServiceTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_MechanicId",
                table: "LeaveRequests",
                column: "MechanicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartStockAlerts_PartId",
                table: "PartStockAlerts",
                column: "PartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRecords_MechanicId_Year_Month",
                table: "PayrollRecords",
                columns: new[] { "MechanicId", "Year", "Month" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ServiceTicketId",
                table: "Reviews",
                column: "ServiceTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTicketItems_PartId",
                table: "ServiceTicketItems",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTicketItems_ServiceTicketId",
                table: "ServiceTicketItems",
                column: "ServiceTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTicketItems_ServiceTypeId",
                table: "ServiceTicketItems",
                column: "ServiceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTickets_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTickets_MechanicId",
                table: "ServiceTickets",
                column: "MechanicId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketNotes_ServiceTicketId",
                table: "TicketNotes",
                column: "ServiceTicketId");
        }
